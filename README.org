...
Please download and install [[http://redis.io/download][Redis]]. Be sure to check your systems package manager (APT, YUM, Hombrew, Ports, etc.) because there is a high change Redis is available there.
...
Counters let you atomically count.
